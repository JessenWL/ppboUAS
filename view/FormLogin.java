...
public class FormLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/zahwa.png"))); // NOI18N
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        try {
            ...
            String sql = "select * from login where username ='" + txt_username.getText() +"' and password='" + txt_pass.getText() + "';";
